...
def runts(tradingSystem=None, plotEquity=True, reloadData=False, state={}, sourceData='tickerData'):
    ...
    Returns:
        ...
        keys and description:
            ...
            'fundEquity' (float):    Equity curve for the fundamental_analysis (collection of all markets)
            'returns' (float): Marketwise returns of trading system
            'marketEquity' (float):    Equity curves for each market in the fundamental_analysis
            'marketExposure' (float):    Collection of the returns p of the trading system function. Equivalent to the percent expsoure of each market in the fundamental_analysis. Normalized between -1 and 1
...
def computeFees(equityCurve, managementFee, performanceFee):
    ...
    Args:
        equityCurve (list, numpy array) : a column vector of daily fundamental_analysis values
